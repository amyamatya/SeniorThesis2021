function [rad, trans, vert] = myrotate(station, startT, endT, azim, components)
...
url = sprintf('https://service.iris.edu/irisws/rotation/1/query?net=II&sta=SACV&loc=00&chaset=BH&starttime=%s&endtime=%s&components=%s&azimuth=%f&correct=none&output=sacbl&nodata=404',startT, endT, components, azim);
else
...
% Organize components
radFile = char(a(contains(a, 'BHR') | contains(a, 'BHE') | contains(a, 'BH1')));
transFile = char(a(contains(a, 'BHT') | contains(a, 'BHN') | contains(a, 'BH2')));
